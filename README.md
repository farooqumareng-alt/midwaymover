...
This repository is at **Phase 0 (product specification)** — no application
code has been written yet. Start here:
...
- [`docs/PHASE-0-SPECIFICATION.md`](docs/PHASE-0-SPECIFICATION.md) — product
  ...
  repo structure, integrations, testing strategy, open questions, MVP
  boundary, and the phase-by-phase plan.
- [`CLAUDE.md`](CLAUDE.md) — working rules for anyone (human or AI) building
  this codebase.

Phase 0 has open questions (see spec §O) that need an answer from the
project owner before Phase 1 (database design) locks in.
